...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contents: Schema.Attribute.Component<'basic.contents', true> &
    ...
    project: Schema.Attribute.Relation<'oneToMany', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'images'>;
    introduce: Schema.Attribute.RichText;
    ...
    technology_knowledge: Schema.Attribute.Relation<
      'manyToMany',
      'api::technology.technology'
    >;
    technology_proficient: Schema.Attribute.Relation<
      'manyToMany',
      'api::technology.technology'
    >;
    updatedAt: Schema.Attribute.DateTime;
